...
| 003 | [Bounded Duplicate Inspection](003-bounded-duplicate-inspection.md) | Implemented (pending commit) | 001 | Bounded duplicate-group and member inspection with complete aggregate metrics. |`r`n| 003.1 | [Catalog Safety and Boundary Test Expansion](003.1-catalog-safety-and-boundary-tests.md) | Implemented (pending commit) | 003 | Regression coverage for transactional, persistence, filesystem, hashing, location, refresh, and CLI safety boundaries. |
