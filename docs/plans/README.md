...
| 003.3 | [Bounded Tag and File Search](003.3-bounded-tag-and-file-search.md) | Incomplete | 003.2 | Original combined scope, retained for history and review. |
| 003.3a | [Bounded Tag Query APIs](003.3a-bounded-tag-query-apis.md) | Planned (review only) | 003.2 | Typed bounded multi-tag, current-file, and vocabulary query APIs. |
| 003.3b | [Tag-Aware File and Content CLI](003.3b-tag-aware-file-and-content-cli.md) | Planned (review only) | 003.3a | Compatible file/content search CLI and tables. |
| 003.3c | [Tag Vocabulary CLI](003.3c-tag-vocabulary-cli.md) | Planned (review only) | 003.3a | Available-tag CLI command and table. |
